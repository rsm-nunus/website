...
# # Quick sanity checks
# print(f"Blueprinty shape: {blueprinty.shape}")
# print(f"Airbnb shape: {airbnb.shape}")

# blueprinty.head()  # optional: peek at the first 5 rows
...
# Map the 0/1 flag to readable labels
